                ...
                Yodo1MasInterstitialAd.getInstance().setAdListener(new Yodo1MasInterstitialAdListener() {
                    ...
                    public void onInterstitialAdLoaded(Yodo1MasInterstitialAd ad) {
                        activity.runOnGLThread( new Runnable() {
                            public void run() {
                                Cocos2dxJavascriptJavaBridge.evalString("cc.find(\"Yodo1\").getComponent(\"Yodo1Ads\").onInterstitialAdLoaded()");
                            }
                        });
                    }
                    ...
                    public void onInterstitialAdFailedToLoad(Yodo1MasInterstitialAd ad, @NonNull Yodo1MasError error) {
                        activity.runOnGLThread( new Runnable() {
                            public void run() {
                                Cocos2dxJavascriptJavaBridge.evalString("cc.find(\"Yodo1\").getComponent(\"Yodo1Ads\").onInterstitialAdFailedToLoad()");
                            }
                        });
                    }
                    ...
                    public void onInterstitialAdOpened(Yodo1MasInterstitialAd ad) {
                        activity.runOnGLThread( new Runnable() {
                            public void run() {
                                Cocos2dxJavascriptJavaBridge.evalString("cc.find(\"Yodo1\").getComponent(\"Yodo1Ads\").onInterstitialAdOpened()");
                            }
                        });
                    }
                    ...
                    public void onInterstitialAdFailedToOpen(Yodo1MasInterstitialAd ad, @NonNull Yodo1MasError error) {
                        ...
                        activity.runOnGLThread( new Runnable() {
                            public void run() {
                                Cocos2dxJavascriptJavaBridge.evalString("cc.find(\"Yodo1\").getComponent(\"Yodo1Ads\").onInterstitialAdFailedToOpen()");
                            }
                        });
                    }
                    ...
                    public void onInterstitialAdClosed(Yodo1MasInterstitialAd ad) {
                        ...
                        activity.runOnGLThread( new Runnable() {
                            public void run() {
                                Cocos2dxJavascriptJavaBridge.evalString("cc.find(\"Yodo1\").getComponent(\"Yodo1Ads\").onInterstitialAdClosed()");
                            }
                        });
                    }
                });
            ...
            public void run() {
                ...
                Yodo1MasRewardAd.getInstance().setAdListener(new Yodo1MasRewardAdListener() {
                    ...
                    public void onRewardAdLoaded(Yodo1MasRewardAd ad) {
                        activity.runOnGLThread( new Runnable() {
                            public void run() {
                                Cocos2dxJavascriptJavaBridge.evalString("cc.find(\"Yodo1\").getComponent(\"Yodo1Ads\").onRewardAdLoaded()");
                            }
                        });
                    }
                    ...
                    public void onRewardAdFailedToLoad(Yodo1MasRewardAd ad, @NonNull Yodo1MasError error) {
                        activity.runOnGLThread( new Runnable() {
                            public void run() {
                                Cocos2dxJavascriptJavaBridge.evalString("cc.find(\"Yodo1\").getComponent(\"Yodo1Ads\").onRewardAdFailedToLoad()");
                            }
                        });
                    }
                    ...
                    public void onRewardAdOpened(Yodo1MasRewardAd ad) {
                        activity.runOnGLThread( new Runnable() {
                            public void run() {
                                Cocos2dxJavascriptJavaBridge.evalString("cc.find(\"Yodo1\").getComponent(\"Yodo1Ads\").onRewardAdOpened()");
                            }
                        });
                    ...
                    public void onRewardAdFailedToOpen(Yodo1MasRewardAd ad, @NonNull Yodo1MasError error) {
                        ...
                        activity.runOnGLThread( new Runnable() {
                            public void run() {
                                Cocos2dxJavascriptJavaBridge.evalString("cc.find(\"Yodo1\").getComponent(\"Yodo1Ads\").onRewardAdFailedToOpen()");
                            }
                        });
                    }
                    ...
                    public void onRewardAdClosed(Yodo1MasRewardAd ad) {
                        ...
                        activity.runOnGLThread( new Runnable() {
                            public void run() {
                                Cocos2dxJavascriptJavaBridge.evalString("cc.find(\"Yodo1\").getComponent(\"Yodo1Ads\").onRewardAdClosed()");
                            }
                        });
                    }
                    ...
                    public void onRewardAdEarned(Yodo1MasRewardAd ad) {
                        ...
                        activity.runOnGLThread( new Runnable() {
                            public void run() {
                                Cocos2dxJavascriptJavaBridge.evalString("cc.find(\"Yodo1\").getComponent(\"Yodo1Ads\").onRewardAdEarned()");
                            }
                        });
    ...
    public static void loadBannerAds(String size, String horizontal_alignment, String vertical_alignment)
    {
        activity.runOnUiThread( new Runnable() {
            public void run() {
                ...
                if(horizontal_alignment.equalsIgnoreCase("TOP"))
                    adRelativeLayout.setVerticalGravity(Gravity.TOP);
                else if(horizontal_alignment.equalsIgnoreCase("BOTTOM"))
                ...
                bannerAdView.setAdListener(new Yodo1MasBannerAdListener() {
                    @Override public void onBannerAdLoaded(Yodo1MasBannerAdView bannerAdView) {
                        activity.runOnGLThread( new Runnable() {
                            public void run() {
                                Cocos2dxJavascriptJavaBridge.evalString("cc.find(\"Yodo1\").getComponent(\"Yodo1Ads\").onBannerAdLoaded()");
                            }
                        });
                    }
                    @Override
                    public void onBannerAdFailedToLoad(Yodo1MasBannerAdView bannerAdView, @NonNull Yodo1MasError error) {
                        activity.runOnGLThread( new Runnable() {
                            public void run() {
                                Cocos2dxJavascriptJavaBridge.evalString("cc.find(\"Yodo1\").getComponent(\"Yodo1Ads\").onBannerAdFailedToLoad()");
                            }
                        });
                    }
                    @Override public void onBannerAdOpened(Yodo1MasBannerAdView bannerAdView) {
                        activity.runOnGLThread( new Runnable() {
                            public void run() {
                                Cocos2dxJavascriptJavaBridge.evalString("cc.find(\"Yodo1\").getComponent(\"Yodo1Ads\").onBannerAdOpened()");
                            }
                        });
                    }
                    @Override
                    public void onBannerAdFailedToOpen(Yodo1MasBannerAdView bannerAdView, @NonNull Yodo1MasError error) {
                        activity.runOnGLThread( new Runnable() {
                            public void run() {
                                Cocos2dxJavascriptJavaBridge.evalString("cc.find(\"Yodo1\").getComponent(\"Yodo1Ads\").onBannerAdFailedToOpen()");
                            }
                        });
                    }
                    @Override
                    public void onBannerAdClosed(Yodo1MasBannerAdView bannerAdView) {
                        activity.runOnGLThread( new Runnable() {
                            public void run() {
                                Cocos2dxJavascriptJavaBridge.evalString("cc.find(\"Yodo1\").getComponent(\"Yodo1Ads\").onBannerAdClosed()");
                            }
                        });
                    }
                });
